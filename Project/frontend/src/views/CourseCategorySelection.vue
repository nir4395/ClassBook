...
export default {
    data(){
        return{
            ...
            courseCategoriesInfo:''
        }
    },
    created(){
        var url='http://localhost:8000/course/get/course_id='+this.id+'/categories'
        this.$http.get(url).then(response => (this.courseCategoriesInfo = response.data))
