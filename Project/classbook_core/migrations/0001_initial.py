...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AcademicDegree',
            fields=[
                ('degree_id', models.IntegerField(primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_rated', models.ManyToManyField(to='classbook_core.Profile')),
            ],
        ),
        migrations.AddField(
            model_name='course',
