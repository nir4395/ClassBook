    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_count', models.IntegerField(default=5, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='Project/storage/profile_pictures/', validators=[django.core.validators.validate_image_file_extension])),
                ('institution', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classbook_core.institution')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classbook_core.document')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classbook_core.profile')),
            ],
        ),
        migrations.AddField(
            model_name='document',
        ...
        migrations.AddField(
            model_name='document',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classbook_core.course'),
        ),
        migrations.AddField(
            model_name='document',
            name='recent_profile_access',
            field=models.ManyToManyField(through='classbook_core.DocumentAccess', to='classbook_core.Profile'),
        ),
        migrations.AddField(
            model_name='document',
            name='student_rated',
            field=models.ManyToManyField(related_name='document_students_rated', to='classbook_core.Profile'),
        ),
        migrations.AddField(
            model_name='course',
            name='institution',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classbook_core.profile')),
                ('replied_to_comment', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='classbook_core.comment')),
            ],
        ),
        migrations.AddField(
